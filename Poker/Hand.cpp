...
HandComparrison Hand::getWinner(const Hand& other) const
{
   ...
   if (isStraightFlush(winningRank1))
   {
      if (other.isStraightFlush(winningRankOther1))
      {
         // arbitrate winner
   ...
   else if (isFullHouse(winningRank1, winningRank2, losingRank))
   {
      if (other.isFullHouse(winningRankOther1, winningRankOther2, losingRankOther))
      {
         // arbitrate winner
         if (winningRank1 > winningRankOther1)
         {
   ...
   else if (isStraight(winningRank1))
   {
      if (other.isStraight(winningRankOther1))
      {
         // arbitrate winner
         if (winningRank1 > winningRankOther1)
         {
   ...
   else if (isThreeOfKind(winningRank1, losingRank))
   {
      if (other.isThreeOfKind(winningRankOther1, losingRankOther))
      {
         // arbitrate winner
         if (winningRank1 > winningRankOther1)
         {
   ...
   else if (isTwoPair(winningRank1, winningRank2, losingRank))
   {
      if (other.isTwoPair(winningRankOther1, winningRankOther2, losingRankOther))
      {
         // arbitrate winner
         if (winningRank1 > winningRankOther1)
         {
   ...
   else if (isOnePair(winningRank1, losingRank))
   {
      if (other.isOnePair(winningRankOther1, losingRankOther))
      {
         // arbitrate winner
         if (winningRank1 > winningRankOther1)
         {
